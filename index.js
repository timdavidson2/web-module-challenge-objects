...
function createMenuItem(name, price, category){
 ...
 console.log(createMenuItem('Cafe Latta', 4, 'shakes'));
...
*/
reviews.push({name: "Sebastian", rating: 2, feedback: "Not worth the time or money."});
console.log(reviews);
...
*/
// reviews.splice(feedback: "this place is chill with really cool people, great for getting work done on weekdays");
// console.log(reviews);
